...
const BookDetails: React.FC = () => {
  ...
  if (!book) {
    return <p className="text-center text-gray-800 dark:text-gray-100">Book not found.</p>;
  }
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:ml-6 flex-grow">
            <h1 className="text-4xl font-bold mb-4 text-gray-800 dark:text-gray-100">{book.title}</h1>
            <p className="text-xl mb-6 text-gray-600 dark:text-gray-300">{book.author}</p>
            <p className="text-lg text-gray-700 dark:text-gray-400 mb-4">{book.about}</p>
            {book.qty > 0 ? (
              <Chip
                className="text-gray-700 dark:text-gray-200 mb-4"
                style={{ padding: "5px", paddingRight: "2px", height: "2rem", backgroundColor: "transparent" }}
                startContent={
                  <svg
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Add Your Note</h2>
              <Input
